...
import com.example.hypersonalbooster.databinding.FragmentSearchBoosterAdapterBinding
import com.google.firebase.storage.FirebaseStorage
import com.google.firebase.storage.StorageReference


class ListViewAdapter_KioskBoosterSearch(private val context: Context, private val booster_list : ArrayList<Booster>, private val listener : OnRecommendBoosterClickListener)
    : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val binding = FragmentSearchBoosterAdapterBinding.inflate(LayoutInflater.from(context))
