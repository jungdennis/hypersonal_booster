...
class RecommendActivity_After() : AppCompatActivity(), CloudCallbackListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val flag = getSharedPreferences("data_cloud", 0).getString("flag_after", "false")
        if(flag == "true") {
            val intent = Intent(this, RecommendActivity_Save::class.java)
