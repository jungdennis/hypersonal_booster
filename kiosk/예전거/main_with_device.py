...
#텀블러인식 -> qr코드인식
def change1to2():
    label_subtext.configure(text='버튼을 눌러 qr코드 인식창을 띄워주세요')
...
#서버통신 -> 프로틴확인절차, YES->프로틴투하, NO->다시서버와통신
def change3to4():
...
def change4to5():
    ...
    label_maintext.configure(text='버튼을 누르면 투하가 시작됩니다')
